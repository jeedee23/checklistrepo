...
// Import getter functions from user-management.js (one-way import)
import { getUsersData, getCurrentUserIndex, setCurrentUserIndex } from './user-management.js';
...
export function createUserManagementDialog() {
  ...
  dialog.innerHTML = `
    ...
    <div class="modal-body">
      ...
      <div style="margin-bottom: 10px; padding: 10px; background: #e9ecef; border-radius: 4px; border: 1px solid #dee2e6; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0;">
        <div>
