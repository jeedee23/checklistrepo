...
// Callback for dialog creation - set by UserManagementDialog.js
let createDialogCallback = null;
export function setCreateDialogCallback(callback) {
  ...
  try {
    ...
    loadUsersData().then(() => {
      ...
      if (createDialogCallback) {
        ...
        console.error('[User Management] Dialog callback not set!');
      }
    }).catch(error => {
