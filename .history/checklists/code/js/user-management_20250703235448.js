  ...
  dialog.innerHTML = `
    ...
    <div class="modal-body" style="padding: 20px; max-height: 70vh; overflow-y: auto;">
      <form id="user-form">
        ...
        <!-- User Checklists -->
        <div class="form-section">
          <h4>ASSIGNED_CHECKLISTS (${currentUser.checklists?.length || 0})</h4>
          <div id="user-checklists" style="max-height: 150px; overflow-y: auto; border: 1px solid #000; padding: 8px; background: #f8f9fa;">
        ...
        <!-- 2FA Status -->
        <div class="form-section">
          <h4>TWO_FACTOR_AUTHENTICATION</h4>
          <div style="padding: 8px; background: #f8f9fa; border: 1px solid #000;">
            ...
            <button type="button" id="setup-2fa" class="btn-secondary" style="margin-top: 8px;">
