...
function createUserManagementInContainer() {
  ...
  const userManagementHTML = `
    <div class="user-management-container" style="height: 100%; display: flex; flex-direction: column; background: white; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); overflow: hidden;">
      <div class="modal-header" style="padding: 15px; border-bottom: 1px solid #dee2e6; display: flex; justify-content: space-between; align-items: center; background-color: #f8f9fa; margin: -20px -20px 20px -20px; border-radius: 8px 8px 0 0;">
      ...
      <div class="modal-body" style="background: #f5f5f5; padding: 20px; margin: 0 -20px -20px -20px; border-radius: 0 0 8px 8px;">
        ...
        <table class="form-table" style="width: 100%; border-collapse: collapse; font-family: Consolas, monospace; font-size: 10pt;">
          <!-- PERSONAL DATA Section -->
          <tr>
