...
// Export functions needed by menu-core.js (temporary, will be removed as functions are moved)
export { 
  // No more functions to export - all have been moved to specific modules
};
