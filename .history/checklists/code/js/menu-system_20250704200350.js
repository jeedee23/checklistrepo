...
/**
 * Show about dialog - placeholder function
 */
function showAboutDialog() {
  alert('MeamTreelistApp - Checklist Management System\n\nVersion: 1.0\nA collaborative checklist application.');
}

/**
 * Show keyboard shortcuts dialog - placeholder function
 */
...
Tab - Add item at same level
Shift+Tab - Add sub-item
Ctrl+B - Toggle bold
Ctrl+E - Expand all
Ctrl+R - Collapse all
  `;
